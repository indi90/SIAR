...
public class RAAModel {
    ...
    public RAAModel(int IRPeriodID, int IRAssetNo, String IRModel, String IRMFGNo, int IRLocationID, String IRGenerateDate, String IRGenerateUser, int IRDeptCode)
    {
