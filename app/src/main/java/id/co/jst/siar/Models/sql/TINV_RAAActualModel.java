...
public class TINV_RAAActualModel {
    ...
    public TINV_RAAActualModel()
    {
    }

    public TINV_RAAActualModel(int IRPeriodID, int IRAssetNo, String IRModel, String IRMFGNo, int IRLocationID, String IRGenerateDate, String IRGenerateUser, int IRDeptCode)
    {
