...
public class TINV_RAAPeriodModel {
    private int irp_id;
    ...
    public TINV_RAAPeriodModel()
    {
    }

    public TINV_RAAPeriodModel(int irp_id, int irp_period, int irp_year, int irp_month, int irp_status, String irp_generatedate, String irp_inventoryopen, String irp_inventoryclose)
    {
        this.irp_id = irp_id;
