...
public class TBMFAPlaceModel {
    ...
    public TBMFAPlaceModel()
    {
    }

    public TBMFAPlaceModel(int pl_code, String pl_building, String pl_floor, String pl_place, String pl_description, String pl_date)
    {
